...
export const CONFIG = {
  ...
  // ブレ取り（One-Euroフィルター）。手ぶれを消しつつ遅延も抑える。
  AIM_SMOOTH_MIN_CUTOFF: 1.2, // 小さいほど静止時のブレを強く取る（ただし遅延も増える）
  AIM_SMOOTH_BETA: 0.012,     // 大きいほど速い動きに即追従（戻りが速い）
  // 手のひらの向きが急にブレないよう、向きベクトル自体も軽く平滑化する(0=なし..1=強)
  AIM_NORMAL_SMOOTH: 0.35,
